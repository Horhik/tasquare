      ...
      <header className={"header"}>
        ...
        <nav className={"priority--wrapper"}>
          <ul className={"priority--inner"}>
            <li>
              <Priority
                selected={this.state.boolFilter[0]}
                label={this.state.filter[0]}
              />
            </li>
            <li>
              <Priority
                selected={this.state.boolFilter[1]}
                label={this.state.filter[1]}
              />
            </li>
            <li>
              <Priority
                selected={this.state.boolFilter[2]}
                label={this.state.filter[2]}
              />
            </li>
            <li>
              <Priority
                selected={this.state.boolFilter[3]}
                label={this.state.filter[3]}
              />
            </li>
          </ul>
        </nav>
